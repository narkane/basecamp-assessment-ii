...
console.log(adjustCount.upVote(1)+","+adjustCount.downVote(1));

// #5 Create an array called 'myFriends' with four of your friends names

// CODE HERE
var myFriends = new Array("Kim", "Jeremy", "Lauren", "Kris");

// #6 Add a fifth friends name to the end of your myFriends array

// CODE HERE
myFriends.push("Bruce");
...
function evensOnly() {
  // CODE HERE
  var evensArray = myNumbers.filter(function(ary){
    if((ary%2)==0){
      return ary;
    }
  });
...
var trueFriends = peopleIknow.filter(function(ppl){
  if(ppl.friend == true){
    return ppl;
  }
});
